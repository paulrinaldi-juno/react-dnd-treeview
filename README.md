...
| topLevelFolderSeparator | `boolean` \| `ReactElement` |          | `false`     | When truthy, renders content between top-level nodes. Set to `true` to use the default separator or provide a custom React element for full control. |
